const comprarProductos = () => {
    ...
    do {
        producto = prompt ("Que vas a llevar, fideos, arroz o polenta?");
    ...
    seguirComprando = confirm("¿Querés agregar algo mas?");
...
const calcularEnvio = (totalCompra) => {
    ...
    tieneEnvioADomicilio = confirm("¿Lo enviamos a domicilio?");
